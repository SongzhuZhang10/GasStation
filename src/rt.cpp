...
CPipe::CPipe(const string& Name, UINT SizeOfPipe) :PipeName(Name)
{
	...
	hPipe = CreateFileMapping((HANDLE)0xFFFFFFFFFFFFFFFF,
		NULL,
		PAGE_READWRITE,
		0,
		sizeof(PIPECONTROL),
	...
	hData = CreateFileMapping((HANDLE)0xFFFFFFFFFFFFFFFF,
		NULL,
		PAGE_READWRITE,
		0,
		sizeof(SizeOfPipe),
...
CDataPool::CDataPool(const string& Name, UINT size)
	:DataPoolName(Name)
{
	DPInfo.DataPoolHandle = CreateFileMapping((HANDLE)0xFFFFFFFFFFFFFFFF,
		NULL,
		PAGE_READWRITE,
		0,
		size,
